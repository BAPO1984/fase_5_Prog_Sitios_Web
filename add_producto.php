                  ...
                  echo "La base de Datos ".$BD. " No existe.";
                    ...
                    if (mysql_num_rows($insert)>=1) {
                      echo "Ya existe un Producto Registrado con el código: ".$codigo; }
                        ...
                        mysql_query("INSERT INTO $tabla (codigo, nombre, marca, precio, cantidad) VALUES('$codigo', '$nombre', '$marca', '$precio', '$cantidad')");

                     echo " El producto ".$codigo."  ha sido registrado con éxito.";
                      }
