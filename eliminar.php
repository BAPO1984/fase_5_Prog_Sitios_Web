...
//            $cantidad=$_POST["cantidad"];
                ...
                { 
                  ...
                  echo "La base de Datos ".$BD. " No existe.";
                    ...
                    if (mysql_num_rows($consulta)>=1) {
                      ...
                      echo "<strong> El Producto con Código ".$codigo." se ha Eliminado de la Base de Datos:</strong><br>";
          ...
          <form action="eliminar_prod.html">
            <center><input type="submit" class=" col-sm-2 btn btn-success btn-outline-warning text-center" name="continuar" value=" Volver "> </center> <br>
          </form>
